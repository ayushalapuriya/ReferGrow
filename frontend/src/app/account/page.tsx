    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 flex items-center justify-center p-6">
      <div className="w-full max-w-4xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Link 
            className="glass-panel animate-fade-in rounded-2xl border border-purple-200 p-8 transition-all hover:scale-105 hover:shadow-2xl group" 
            prefetch={false}
            href="/login"
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white text-3xl group-hover:scale-110 transition-transform">
                ✨
              </div>
        ...
        <div className="mt-12 glass-panel animate-fade-in rounded-2xl border border-purple-200 p-6 text-center" style={{animationDelay: '0.3s'}}>
