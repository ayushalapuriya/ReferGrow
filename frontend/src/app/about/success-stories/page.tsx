    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="glass-panel animate-fade-in rounded-2xl border border-purple-200 p-8" style={{animationDelay: '0.1s'}}>
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h3 className="font-bold text-xl text-purple-600">Sarah Johnson</h3>
          ...
          <div className="glass-panel animate-fade-in rounded-2xl border border-purple-200 p-8" style={{animationDelay: '0.2s'}}>
            <div className="flex items-start gap-4 mb-4">
          ...
          <div className="glass-panel animate-fade-in rounded-2xl border border-purple-200 p-8" style={{animationDelay: '0.3s'}}>
            <div className="flex items-start gap-4 mb-4">
          ...
          <div className="glass-panel animate-fade-in rounded-2xl border border-purple-200 p-8" style={{animationDelay: '0.4s'}}>
            <div className="flex items-start gap-4 mb-4">
        ...
        <div className="mt-12 glass-panel animate-fade-in rounded-2xl border border-purple-200 p-8 text-center" style={{animationDelay: '0.5s'}}>
