import { BarChart3, Lock, Infinity } from "lucide-react";
      ...
      <div className="mx-auto max-w-4xl">
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 md:p-12">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Our Vision</h1>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <div className="text-center p-6 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
            ...
            <div className="text-center p-6 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Real-Time Updates</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="text-center p-6 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Secure & Fair</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
