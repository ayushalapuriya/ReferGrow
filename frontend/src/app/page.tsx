          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gray-100 text-gray-900 font-medium rounded-lg border border-gray-300 hover:bg-gray-200 transition-all"
              >
                Learn More
              </Link>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-8 border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Earn Through Referrals</h3>
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Binary Tree Structure</h3>
              <p className="text-gray-800">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              ...
              <div className="text-gray-800">Active Members</div>
            </div>
            <div className="p-6">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4 mx-auto">
                <TrendingUp className="w-6 h-6 text-blue-600" />
              ...
              <div className="text-gray-800">Distributed Income</div>
            </div>
            <div className="p-6">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4 mx-auto">
              ...
              <div className="text-gray-800">Secure Platform</div>
            </div>
          </div>
        </div>
      </section>
